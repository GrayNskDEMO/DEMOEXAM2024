...
echo "ISP is done!!!"
qm create 102 --name "HQ-R" --cores 2 --memory 2048 --ostype l26 --scsihw virtio-scsi-single  --net0 virtio,bridge=vmbr7
qm importdisk 102 ISP-disk001.vmdk $STORAGE --format qcow2
qm set 102 -sata0 $STORAGE:102/vm-102-disk-0.qcow2 --boot order=ide0
echo "HQ-R is done!!!"
qm create 103 --name "BR-R" --cores 2 --memory 4096 --ostype l26 --scsihw virtio-scsi-single  --net0 virtio,bridge=vmbr7
qm importdisk 101 ISP-disk001.vmdk $STORAGE --format qcow2
